...
export type GetWeekSummary200GoalsPerDayItem = {
  completedAt: string;
  id: string;
  title: string;
};
 ...
 * @nullable
 */
export type GetWeekSummary200GoalsPerDay = {[key: string]: GetWeekSummary200GoalsPerDayItem[]} | null;

export type GetWeekSummary200 = {
  completed: number;
  /** @nullable */
  goalsPerDay: GetWeekSummary200GoalsPerDay;
  /** @nullable */
  total: number | null;
};
